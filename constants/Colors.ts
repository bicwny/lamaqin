...
export const Colors = {
  ...
  secondary: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"],
  text: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-primary"],
  textSecondary: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-secondary"],
  textPrimary: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-primary"],
  background: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"],
  surface: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"]Secondary,
  border: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["border-default"],
