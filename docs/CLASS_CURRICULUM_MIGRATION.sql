...
UPDATE user_practice_projects upp
SET practice_id = ptr.new_id
FROM practices_to_remove ptr
...
-- 加行 session-based practice (368 sessions total: 92座 × 4 sessions/座, 4/week, 92 weeks, 30min minimum)
