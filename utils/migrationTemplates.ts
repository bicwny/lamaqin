...
export const ImportReplacements = {
  ...
  colorReplacements: {
    'Colors.light.text': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-primary"]',
    'Colors.light.background': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"]',
    'Colors.light.tint': 'ConsolidatedConsolidatedConsolidatedConsolidatedDesignSystem.colors.primary',
    'Colors.light.tabIconDefault': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-secondary"]',
    'Colors.light.tabIconSelected': 'ConsolidatedConsolidatedConsolidatedConsolidatedDesignSystem.colors.primary',
    'Colors.dark.text': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-inverse"]',
    'Colors.dark.background': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"]Secondary',
    'Colors.primary': 'ConsolidatedConsolidatedConsolidatedConsolidatedDesignSystem.colors.primary',
    'Colors.secondary': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-secondary"]',
    'Colors.background': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"]',
    'Colors.white': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"]Secondary',
    'Colors.black': 'ConsolidatedConsolidatedConsolidatedDesignSystem.colors["text-primary"]',
  },
};
