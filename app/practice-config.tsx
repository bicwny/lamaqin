...
const styles = StyleSheet.create({
  ...
  segmentedControl: {
    ...
    padding: ConsolidatedConsolidatedDesignSystem.spacing.xs,
  },
  segmentButton: {
    flex: 1,
  ...
  inputUnit: {
    ...ComponentTextStyles.body,
    marginLeft: ConsolidatedConsolidatedDesignSystem.spacing.sm,
  },
  goalTypeContainer: {
  ...
  durationDisplay: {
    backgroundColor: ConsolidatedConsolidatedConsolidatedDesignSystem.colors["surface-primary"],
    borderRadius: ConsolidatedConsolidatedDesignSystem.borderRadius.sm,
    padding: ConsolidatedConsolidatedDesignSystem.spacing.sm,
    borderLeftWidth: 3,
  ...
  previewDetails: {
    gap: ConsolidatedConsolidatedDesignSystem.spacing.xxs,
  },
  previewDetailItem: {
    ...ComponentTextStyles.body,
  ...
  clearButton: {
    position: "absolute",
    right: ConsolidatedConsolidatedDesignSystem.spacing['3xl'],
    top: ConsolidatedConsolidatedDesignSystem.spacing.md,
    width: ConsolidatedConsolidatedDesignSystem.spacing['2xl'],
    height: ConsolidatedConsolidatedDesignSystem.spacing['2xl'],
    borderRadius: ConsolidatedConsolidatedDesignSystem.spacing.md,
  ...
  modalEmptyState: {
    ...
    justifyContent: "center",
    alignItems: "center",
    paddingVertical: ConsolidatedConsolidatedDesignSystem.spacing['5xl'],
    paddingHorizontal: ConsolidatedConsolidatedDesignSystem.spacing['3xl'],
  },
  modalEmptyText: {
    ...ComponentTextStyles.body,
    textAlign: "center",
